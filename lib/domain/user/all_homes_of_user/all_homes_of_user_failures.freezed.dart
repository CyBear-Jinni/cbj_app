...
part of 'all_homes_of_user_failures.dart';
...
/// @nodoc
class _$AllHomesOfUserFailuresTearOff {
  const _$AllHomesOfUserFailuresTearOff();
...
/// @nodoc
const $AllHomesOfUserFailures = _$AllHomesOfUserFailuresTearOff();

/// @nodoc
mixin _$AllHomesOfUserFailures<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $AllHomesOfUserFailuresCopyWith<T, $Res> {
  factory $AllHomesOfUserFailuresCopyWith(AllHomesOfUserFailures<T> value,
          $Res Function(AllHomesOfUserFailures<T>) then) =
      _$AllHomesOfUserFailuresCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$AllHomesOfUserFailuresCopyWithImpl<T, $Res>
    implements $AllHomesOfUserFailuresCopyWith<T, $Res> {
  _$AllHomesOfUserFailuresCopyWithImpl(this._value, this._then);

  final AllHomesOfUserFailures<T> _value;
  // ignore: unused_field
  final $Res Function(AllHomesOfUserFailures<T>) _then;
}
...
class __$EmptyCopyWithImpl<T, $Res>
    extends _$AllHomesOfUserFailuresCopyWithImpl<T, $Res>
...
class _$_Empty<T> implements _Empty<T> {
  ...
  @override
  String toString() {
    return 'AllHomesOfUserFailures<$T>.empty(failedValue: $failedValue)';
  }
...
abstract class _Empty<T> implements AllHomesOfUserFailures<T> {
...
class _$_Unexpected<T> implements _Unexpected<T> {
  ...
  @override
  String toString() {
    return 'AllHomesOfUserFailures<$T>.unexpected()';
  }
...
abstract class _Unexpected<T> implements AllHomesOfUserFailures<T> {
...
class _$_ValidateEmailNotEmpty<T> implements _ValidateEmailNotEmpty<T> {
  ...
  @override
  String toString() {
    return 'AllHomesOfUserFailures<$T>.validateEmailNotEmpty()';
  }
...
abstract class _ValidateEmailNotEmpty<T> implements AllHomesOfUserFailures<T> {
...
class _$_InsufficientPermission<T> implements _InsufficientPermission<T> {
  ...
  @override
  String toString() {
    return 'AllHomesOfUserFailures<$T>.insufficientPermission()';
  }
...
abstract class _InsufficientPermission<T> implements AllHomesOfUserFailures<T> {
...
class _$_UnableToUpdate<T> implements _UnableToUpdate<T> {
  ...
  @override
  String toString() {
    return 'AllHomesOfUserFailures<$T>.unableToUpdate()';
  }
...
abstract class _UnableToUpdate<T> implements AllHomesOfUserFailures<T> {
