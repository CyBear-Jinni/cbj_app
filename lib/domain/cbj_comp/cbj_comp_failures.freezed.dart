...
/// @nodoc
abstract class $CBJCompFailureCopyWith<T, $Res> {
  factory $CBJCompFailureCopyWith(
          CBJCompFailure<T> value, $Res Function(CBJCompFailure<T>) then) =
      _$CBJCompFailureCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$CBJCompFailureCopyWithImpl<T, $Res>
    implements $CBJCompFailureCopyWith<T, $Res> {
  _$CBJCompFailureCopyWithImpl(this._value, this._then);

  final CBJCompFailure<T> _value;
  // ignore: unused_field
  final $Res Function(CBJCompFailure<T>) _then;
}
...
class __$EmptyCopyWithImpl<T, $Res>
    extends _$CBJCompFailureCopyWithImpl<T, $Res>
...
class _$_Empty<T> implements _Empty<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.empty(failedValue: $failedValue)';
  }
...
class _$_ActionExcecuter<T> implements _ActionExcecuter<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.actionExcecuter(failedValue: $failedValue)';
  }
...
class _$_ExceedingLength<T> implements _ExceedingLength<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.exceedingLength(failedValue: $failedValue, max: $max)';
  }
...
class _$_Unexpected<T> implements _Unexpected<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.unexpected()';
  }
...
abstract class _Unexpected<T> implements CBJCompFailure<T> {
...
class _$_InsufficientPermission<T> implements _InsufficientPermission<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.insufficientPermission()';
  }
...
abstract class _InsufficientPermission<T> implements CBJCompFailure<T> {
...
class _$_UnableToUpdate<T> implements _UnableToUpdate<T> {
  ...
  @override
  String toString() {
    return 'CBJCompFailure<$T>.unableToUpdate()';
  }
...
abstract class _UnableToUpdate<T> implements CBJCompFailure<T> {
