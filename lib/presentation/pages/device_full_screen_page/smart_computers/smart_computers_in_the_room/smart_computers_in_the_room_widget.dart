...
/// The widgets to show all the smartComputers in selected room
class SmartComputersInTheRoomWidget extends StatelessWidget {
  const SmartComputersInTheRoomWidget(
    this.products,
    this.updateProduct,
    this.deleteProduct,
  );
