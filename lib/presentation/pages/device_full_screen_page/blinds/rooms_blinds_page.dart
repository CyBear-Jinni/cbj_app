...
import 'package:cybear_jinni/presentation/pages/device_full_screen_page/blinds/settings_page_of_blinds_page.dart';
...
class RoomsBlindsPage extends StatelessWidget {
  ...
  void cogFunction(BuildContext context) {
    context.router.push(SettingsRouteOfBlindsRoute(roomEntity: roomEntity));
  }
