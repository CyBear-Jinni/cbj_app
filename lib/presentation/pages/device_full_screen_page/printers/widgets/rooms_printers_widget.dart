...
class RoomsPrintersWidget extends StatefulWidget {
  ...
  @override
  State<RoomsPrintersWidget> createState() => _RoomsPrintersWidgetState();
}

class _RoomsPrintersWidgetState extends State<RoomsPrintersWidget> {
  StreamSubscription<
  ...
  Future<void> _watchAllStarted() async {
    ...
    _deviceStreamSubscription =
        IDeviceRepository.instance.watchPrinters().listen(
