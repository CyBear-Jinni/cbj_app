...
import 'package:cybear_jinni/presentation/pages/device_full_screen_page/smart_plugs/settings_page_of_smart_plug_page.dart';
...
class RoomsSmartPlugsPage extends StatelessWidget {
  ...
  void cogFunction(BuildContext context) {
    context.router.push(SettingsRouteOfSmartPlugsRoute(roomEntity: roomEntity));
  }
