...
class AddSceneWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AddNewSceneBloc, AddNewSceneState>(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: state.allDevicesWithNewAction.length,
                    itemBuilder: (BuildContext context, int index) {
                      final DeviceEntityAbstract currentDevice =
                          state.allDevicesWithNewAction[index];
                      return SceneActionWidget(
                        deviceEntityAbstract: currentDevice,
                        actionToChange: 'on',
                      );
                    },
                  ),
                            ...
                            onPressed: () async {
                              ...
                              if (actionList != null) {
                                context.read<AddNewSceneBloc>().add(
                                      AddNewSceneEvent.addDevicesWithNewActions(
                                        actionList,
                                      ),
                                    );
                              }
