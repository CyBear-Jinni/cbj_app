...
class SecurityBearSetup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<WiFiInformation>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'wiFiFirstPriority',
        protoName: 'wiFiFirstPriority', subBuilder: WiFiInformation.create)
    ..aOM<WiFiInformation>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'wiFiSecondPriority',
        protoName: 'wiFiSecondPriority',
        subBuilder: WiFiInformation.create)
  ...
  factory SecurityBearSetup.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory SecurityBearSetup.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  SecurityBearSetup copyWith(void Function(SecurityBearSetup) updates) =>
      super.copyWith((message) => updates(message as SecurityBearSetup))
          as SecurityBearSetup; // ignore: deprecated_member_use
  ...
  static $pb.PbList<SecurityBearSetup> createRepeated() =>
      $pb.PbList<SecurityBearSetup>();

  @$core.pragma('dart2js:noInline')
  static SecurityBearSetup getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SecurityBearSetup>(create);
...
class WiFiInformation extends $pb.GeneratedMessage {
  ...
  WiFiInformation copyWith(void Function(WiFiInformation) updates) =>
      super.copyWith((message) => updates(message as WiFiInformation))
          as WiFiInformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  static $pb.PbList<WiFiInformation> createRepeated() =>
      $pb.PbList<WiFiInformation>();

  @$core.pragma('dart2js:noInline')
  static WiFiInformation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WiFiInformation>(create);
...
class SBCommendStatus extends $pb.GeneratedMessage {
  ...
  SBCommendStatus copyWith(void Function(SBCommendStatus) updates) =>
      super.copyWith((message) => updates(message as SBCommendStatus))
          as SBCommendStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  static $pb.PbList<SBCommendStatus> createRepeated() =>
      $pb.PbList<SBCommendStatus>();

  @$core.pragma('dart2js:noInline')
  static SBCommendStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SBCommendStatus>(create);
...
class SBFirebaseAccountAndSecurityBearSetup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'SecurityBearConnections'),
      createEmptyInstance: create)
    ..aOM<SBFirebaseAccountInformation>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sBFirebaseAccountInformation',
        protoName: 'sBFirebaseAccountInformation',
        subBuilder: SBFirebaseAccountInformation.create)
    ..aOM<SecurityBearSetup>(
        11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityBearSetup',
        protoName: 'securityBearSetup', subBuilder: SecurityBearSetup.create)
    ..hasRequiredFields = false;
  ...
  factory SBFirebaseAccountAndSecurityBearSetup.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory SBFirebaseAccountAndSecurityBearSetup.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SBFirebaseAccountAndSecurityBearSetup clone() =>
      SBFirebaseAccountAndSecurityBearSetup()..mergeFromMessage(this);

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SBFirebaseAccountAndSecurityBearSetup copyWith(
          void Function(SBFirebaseAccountAndSecurityBearSetup) updates) =>
      super.copyWith((message) =>
              updates(message as SBFirebaseAccountAndSecurityBearSetup))
          as SBFirebaseAccountAndSecurityBearSetup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SBFirebaseAccountAndSecurityBearSetup create() =>
      SBFirebaseAccountAndSecurityBearSetup._();

  SBFirebaseAccountAndSecurityBearSetup createEmptyInstance() => create();

  static $pb.PbList<SBFirebaseAccountAndSecurityBearSetup> createRepeated() =>
      $pb.PbList<SBFirebaseAccountAndSecurityBearSetup>();

  @$core.pragma('dart2js:noInline')
  static SBFirebaseAccountAndSecurityBearSetup getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          SBFirebaseAccountAndSecurityBearSetup>(create);
  ...
  @$pb.TagNumber(10)
  set sBFirebaseAccountInformation(SBFirebaseAccountInformation v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  SBFirebaseAccountInformation ensureSBFirebaseAccountInformation() =>
      $_ensure(0);
  ...
  @$pb.TagNumber(11)
  set securityBearSetup(SecurityBearSetup v) {
    setField(11, v);
  }
...
class SBFirebaseAccountInformation extends $pb.GeneratedMessage {
  ...
  SBFirebaseAccountInformation copyWith(
      ...
      super.copyWith(
              (message) => updates(message as SBFirebaseAccountInformation))
          as SBFirebaseAccountInformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SBFirebaseAccountInformation create() =>
      SBFirebaseAccountInformation._();

  SBFirebaseAccountInformation createEmptyInstance() => create();

  static $pb.PbList<SBFirebaseAccountInformation> createRepeated() =>
      $pb.PbList<SBFirebaseAccountInformation>();

  @$core.pragma('dart2js:noInline')
  static SBFirebaseAccountInformation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SBFirebaseAccountInformation>(create);
