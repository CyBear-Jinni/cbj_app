...
class SmartDeviceInfo extends $pb.GeneratedMessage {
  ...
  SmartDeviceInfo copyWith(void Function(SmartDeviceInfo) updates) =>
      super.copyWith((message) =>
          updates(message as SmartDeviceInfo)); // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set smartDeviceIP($core.String v) {
    $_setString(0, v);
  }
...
class CBJCommendStatus extends $pb.GeneratedMessage {
  ...
  CBJCommendStatus copyWith(void Function(CBJCommendStatus) updates) =>
      super.copyWith((message) => updates(
          message as CBJCommendStatus)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
