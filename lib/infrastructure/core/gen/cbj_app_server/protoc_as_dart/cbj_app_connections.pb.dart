...
class CompInfoSB extends $pb.GeneratedMessage {
  ...
  factory CompInfoSB.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory CompInfoSB.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CompInfoSB copyWith(void Function(CompInfoSB) updates) =>
      super.copyWith((message) => updates(message as CompInfoSB))
          as CompInfoSB; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static CompInfoSB getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CompInfoSB>(create);
